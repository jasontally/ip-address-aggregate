...
/**
 * Version Management Script for IP Address Aggregate
 * 
...
const VERSION_LOCATIONS = [
  {
    file: 'index.html',
    patterns: [
      { regex: /Version (\d+\.\d+\.\d+)/g, template: 'Version {{version}}' },
      { regex: /app\.js\?v=(\d+\.\d+\.\d+)/g, template: 'app.js?v={{version}}' },
    ]
  },
  {
    file: 'package.json',
...
function main() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log('Version Manager for IP Address Aggregate');
    console.log('');
    console.log('Usage:');
