...
test.describe("Mobile Error Handling", () => {
  ...
  test("should show error message for empty input on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should show error for invalid IPv4 CIDR on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should show error for invalid IPv6 CIDR on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should display error message above controls on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should show error for whitespace-only input on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should not show modal when error occurs on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should show error for invalid prefix format on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should show error for invalid IPv4 octets on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should clear previous error on valid input on mobile", async ({ page }) => {
    await page.goto("/");
  ...
  test("should show error message with aria-live on mobile", async ({ page }) => {
    await page.goto("/");
